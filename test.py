...
def test( num_tasks, num_plays, arms=10 ):
    ...
    pols.append( [egreedy_inc.egreedy_inc(b,0.1,0.1), [0]*num_plays, [0]*num_plays] )
    pols.append( [egreedy_inc.egreedy_inc(b,0.1), [0]*num_plays, [0]*num_plays] )
